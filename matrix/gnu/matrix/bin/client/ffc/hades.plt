...
set terminal png font "God-Hades, 13" size 400,600
set output '/home/denis/ffc/gnupl-ffc-git/gnu/matrix/img/ffc/God-Hades.png'
set xtics 40
set ytics 40
set xrange [-1:40]
set yrange [-1:40]
...
y = sinh(40)
f(x,y) = sinh(x) + sinh(y)
set table "/home/denis/ffc/gnupl-ffc-git/gnu/matrix/bin/client/data/ffc/values.txt"
